...
function Steps() {
  return (
    <section id="steps" className="py-20 border-t-4 border-black/50">
      <div className="container">
        <h2 className="text-2xl text-black/75 font-bold text-center w-full mb-8 md:mb-16 md:text-3xl lg:text-5xl">
          {steps.title}
        </h2>
        <div
