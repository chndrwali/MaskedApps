...
import {
  FaLinkedin, FaInstagram, FaTwitter,
} from 'react-icons/fa';

function Developer({ developer }) {
  return (
    <div className="w-full border-[1.5px] border-black/75 rounded-lg shadow-xl px-4 l sm:w-4/5 md:w-[calc(50%-12px)] lg:w-[calc(50%-3rem)] g:px-9">
      <div className="flex flex-wrap justify-center text-center relative">
        ...
        />
        <h3 className="w-full text-xl font-semibold text-black/75 mt-14 mb-1 lg:mt-24 lg:mb-3 lg:text-3xl">
          {developer.name}
        </h3>
        <span className="w-full text-base text-black/75 font-medium mb-2 lg:mb-3 lg:text-lg">
          {developer.title}
        </span>
