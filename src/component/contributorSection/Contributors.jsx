...
function Contributors() {
  return (
    <section id="contributors" className="py-20 border-t-4 border-black/50">
      <div className="container">
        <div className="flex flex-wrap justify-center px-4">
          <h2 className="text-2xl text-black/75 font-bold text-center w-full mb-8 md:mb-12 md:text-3xl lg:text-5xl">
            {contributors.title}
          </h2>
