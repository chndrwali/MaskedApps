...
function ImagePreview() {
  ...
  return (
    <>
      ...
      <button
        type="button"
        className="w-full min-h-[44px] min-w-[44px] inline-flex justify-center bg-gradient-to-br from-violet-500 via-gray-800 to-cyan-600 text-white rounded-md mt-2 p-3 hover:brightness-110 hover:shadow-md transition-all duration-200 ease-in-out text-center cursor-pointer"
